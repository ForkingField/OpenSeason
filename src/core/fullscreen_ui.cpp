...
void FullscreenUI::DrawExitWindow()
{
  ...
  if (BeginHorizontalMenu("exit_window", menu_pos, menu_size, 3))
  {
    ...
    if (HorizontalMenuItem(GetCachedTexture("fullscreenui/exit.png"), FSUI_CSTR("Exit OpenSeason"),
...
void FullscreenUI::DrawDisplaySettingsPage()
{
  ...
  DrawEnumSetting(bsi, FSUI_CSTR("Screenshot Size"),
                  FSUI_CSTR("Determines the size of screenshots created by OpenSeason."), "Display", "ScreenshotMode",
...
void FullscreenUI::DrawAchievementsSettingsPage()
{
  ...
  DrawToggleSetting(bsi, FSUI_ICONSTR(ICON_FA_TROPHY, "Enable Achievements"),
                    FSUI_CSTR("When enabled and logged in, OpenSeason will scan for achievements on startup."),
  ...
  DrawToggleSetting(bsi, FSUI_ICONSTR(ICON_FA_STETHOSCOPE, "Spectator Mode"),
                    FSUI_CSTR("When enabled, OpenSeason will assume all achievements are locked and not send any "
  ...
  DrawToggleSetting(
    ...
    FSUI_CSTR("When enabled, OpenSeason will list achievements from unofficial sets. These achievements are not "
...
void FullscreenUI::DrawAdvancedSettingsPage()
{
  ...
  DrawToggleSetting(bsi, FSUI_CSTR("Log To File"), FSUI_CSTR("Logs messages to openseason.log in the user directory."),
...
TRANSLATE_NOOP("FullscreenUI", "About OpenSeason");
...
TRANSLATE_NOOP("FullscreenUI", "Determines the size of screenshots created by OpenSeason.");
...
TRANSLATE_NOOP("FullscreenUI", "Exit OpenSeason");
...
TRANSLATE_NOOP("FullscreenUI", "Logs messages to openseason.log in the user directory.");
...
TRANSLATE_NOOP("FullscreenUI", "When enabled and logged in, OpenSeason will scan for achievements on startup.");
TRANSLATE_NOOP("FullscreenUI", "When enabled, OpenSeason will assume all achievements are locked and not send any unlock notifications to the server.");
TRANSLATE_NOOP("FullscreenUI", "When enabled, OpenSeason will list achievements from unofficial sets. These achievements are not tracked by RetroAchievements.");
