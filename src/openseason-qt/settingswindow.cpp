...
void SettingsWindow::addPages()
{
  ...
  if (!isPerGameSettings())
  {
    addWidget(
      ...
      tr("<strong>Game List Settings</strong><hr>The list above shows the directories which will be searched by "
         "OpenSeason to populate the game list. Search directories can be added, removed, and switched to "
       ...
       "for additional information."));
  {
    ...
    QString help_text(
      tr("<strong>Achievement Settings</strong><hr>OpenSeason uses RetroAchievements as an achievement database and "
  ...
  if (!isPerGameSettings())
  {
    addWidget(
      ...
      tr("<strong>Folder Settings</strong><hr>These options control where OpenSeason will save runtime data files."));
  }
...
void SettingsWindow::onCopyGlobalSettingsClicked()
{
  ...
  QMessageBox::information(this, tr("OpenSeason Settings"), tr("Per-game configuration copied from global settings."));
}
...
void SettingsWindow::onClearSettingsClicked()
{
  ...
  if (QMessageBox::question(this, tr("OpenSeason Settings"),
  ...
  QMessageBox::information(this, tr("OpenSeason Settings"), tr("Per-game configuration cleared."));
}
