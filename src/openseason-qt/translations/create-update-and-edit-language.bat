@ECHO OFF
REM Script to provide and easy way to update and edit .ts files for OpenSeason.
REM Usage: drag and drop a openseason .ts file on this batch file
REM Author: RaydenX93
REM Credits to Stenzek, Sam Pearman
TITLE OpenSeason - Create, and Edit .ts files (Drag n Drop)
...
:noarg
ECHO ===================================================================
ECHO OpenSeason - Create, Update and Edit .ts files (Drag n Drop)
ECHO ===================================================================
...
IF NOT DEFINED langcode (
	...
	SET filename=openseason-qt_%langcode%.ts
)
