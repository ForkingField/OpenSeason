...
<context>
    ...
    <message>
        ...
        <translation>OpenSeason は、Sony PlayStation&lt;span style=&quot;vertical-align:super;&quot;&gt;TM &lt;/span&gt; コンソールの無料のオープンソースシミュレーター/エミュレーターであり、使いやすさ、スピード、および長期的なメンテナンス性に重点を置いています。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">チートリストをリセットしてもよろしいですか？ OpenSeason データベースにないチートはすべて失われます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">このオプションを有効にすると、OpenSeason のリフレッシュレートを現在のモニターまたは画面と一致させます。&lt;br&gt;垂直同期が不可能な場合(100％以外の速度で実行している場合など)、垂直同期は自動的に無効になります。</translation>
    </message>
    <message>
...
Do you want to load this save and continue?</source>
    ...
    <message>
        <source>OpenSeason can automatically download covers for games which do not currently have a cover set. We do not host any cover images, the user must provide their own source for images.</source>
        <translation type="obsolete">OpenSeason は現在カバーが設定されていないゲームのカバーを自動でダウンロードすることができます。我々はカバー画像を提供していません。ユーザーが自分で画像のダウンロード元を指定する必要があります。</translation>
    </message>
    <message>
...
続行してもよろしいですか？</translation>
    ...
    <message>
        ...
        <translation>&lt;p&gt;申し訳ありませんが、GitHub の公式リリースではない OpenSeason バージョンを更新しようとしています。非互換性を防ぐために、自動更新は公式ビルドでのみ有効になっています。&lt;/p&gt;&lt;p&gt;公式ビルドを取得するには、以下のリンクの「ダウンロードと実行」の手順に従ってください。&lt;/p&gt;&lt;p&gt; &lt;a href=&quot;https://github.com/ForkingField/OpenSeason/&quot;&gt; https://github.com/ForkingField/OpenSeason/ &lt;/a&gt;&lt;/p&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;h1 style=&quot; margin-top:18px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;&quot;&gt;&lt;span style=&quot; font-size:xx-large; font-weight:700;&quot;&gt;OpenSeasonへようこそ!&lt;/span&gt;&lt;/h1&gt;&lt;p&gt;このウィザードは、アプリケーションを使用するために必要な設定手順をガイドします。初めてOpenSeasonをインストールする場合は、&lt;a href=&quot;https://github.com/ForkingField/OpenSeason#downloading-and-running&quot;&gt;https://github.com/ForkingField/OpenSeason#downloading-and-running&lt;/a&gt;のセットアップガイドをご覧になることをお勧めします。&lt;/p&gt;&lt;p&gt;デフォルトではOpenSeasonは&lt;a href=&quot;https://github.com/&quot;&gt;github.com&lt;/a&gt;サーバーにアップデートがあるか確認するために接続し、可能な場合、アップデートパッケージを&lt;a href=&quot;https://github.com/&quot;&gt;github.com&lt;/a&gt;よりダウンロードします。OpenSeasonの起動時にネットワーク接続を行いたくない場合は、「自動更新」のチェックを外してください。自動アップデートの設定は、インターフェイス設定でいつでも変更することができます。&lt;/p&gt;&lt;p&gt;まずは言語とテーマを選択してください。&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;OpenSeasonの動作にはPS1 BIOSが必要です。&lt;/p&gt;&lt;p&gt;法的な理由により、&lt;span style=&quot; font-weight:700;&quot;&gt;お持ちのPS1実機から&lt;/span&gt;BIOSを取得する必要があります。(借用はカウントされない) Caetlaまたは他のユーティリティを使用して、PC上のコンソールのBIOS ROMからイメージを作成する必要があります。&lt;/p&gt;&lt;p&gt;ダンプされたBIOSイメージは、下記のデータディレクトリ内のbiosフォルダに置くか、OpenSeasonに別のディレクトリをスキャンするよう指示することができます。&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
