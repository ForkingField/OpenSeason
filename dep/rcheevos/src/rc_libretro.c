...
static const rc_disallowed_setting_t _rc_disallowed_openseason_settings[] = {
  { "openseason_CDROM.LoadImagePatches", "true" },
  { NULL, NULL }
};
...
static const rc_disallowed_core_settings_t rc_disallowed_core_settings[] = {
  ...
  { "OpenSeason", _rc_disallowed_openseason_settings },
